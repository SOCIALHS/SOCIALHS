...
<body>
	<div id="container" class="mx-auto" style="width: 1000px">
		...
		<hr>
			<table class="table">
				<tr>
					<th scope="col" class="bg-light"><p
							class="lead text-center">글번호</p></th>
				...
				<tr>
					<th scope="col" class="bg-light"><button type="button" class="btn btn-dark"
							onclick="good(this.form)">좋아요</button>
						</p></th>
					<td><p class="lead">${BoardVO.getGood() }</p></td>
				</tr>
				<tr>
					<th scope="col" class="bg-light"><button type="button" class="btn btn-dark"
							onclick="bad(this.form)">별로에요</button></th>
					<td><p class="lead">${BoardVO.getBad() }</p></td>
				</tr>
			</table>
			
			<div class="form-group">
				<button type="button" class="btn btn-info" onclick="update_go(this.form)">수정하기</button>
				<button type="button" class="btn btn-info" onclick="delete_go(this.form)">삭제하기</button>
			</div>
			...
			<div class="card my-4">
				...
				<div class="card-body">
					<form method="post" action="Comment?type=f_writeOk">
						...
						<button type="submit" class="btn btn-dark">댓글 저장하기</button>
					</form>
				</div>
			</div>
