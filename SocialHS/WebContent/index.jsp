	...
	<div id="carouselExampleSlidesOnly" class="carousel slide mx-auto"
		...
		<div class="carousel-inner">
			<div class="carousel-item active">
				<img class="d-block w-100" src="imgs/index00.jpg" alt="First slide">
			</div>
			<div class="carousel-item">
				<img class="d-block w-100" src="imgs/index01.jpg" alt="Second slide">
			</div>
			<div class="carousel-item">
				<img class="d-block w-100" src="imgs/index02.jpg" alt="Third slide">
			</div>
			<div class="carousel-item">
				<img class="d-block w-100" src="imgs/index03.jpg" alt="Fourth slide">
			</div>
			<div class="carousel-item">
				<img class="d-block w-100" src="imgs/index04.jpg" alt="Fifth slide">
			</div>
						<div class="carousel-item">
				<img class="d-block w-100" src="imgs/index05.jpg" alt="Fifth slide">
			</div>
						<div class="carousel-item">
				<img class="d-block w-100" src="imgs/index06.jpg" alt="Fifth slide">
			</div>
						<div class="carousel-item">
				<img class="d-block w-100" src="imgs/index07.jpg" alt="Fifth slide">
			</div>
		</div>
	</div>
